...
- Nvidia: [v0.2.5-hotfix2](https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/cuda-v0.2.5-hotfix2/aleo_prover-v0.2.5_cuda_full_hotfix2.tar.gz)
- AMD: [v0.2.6](https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/ocl-v0.2.6/aleo_prover-v0.2.6_ocl.tar.gz)

## Release-notes

- aleo_prover ocl-v0.2.6
  - 15%+ performance improvement on different AMD GPUs
...
`./aleo_prover --pool aleo.aisa1.zk.work:10003 --pool aleo.hk.zk.work:10003 --pool aleo.jp.zk.work:10003 --pool aleo.eu.zk.work:10003 --address aleoxxx --custom_name myprover`
...
3. Download zkwork AMD miner: `wget https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/ocl-v0.2.6/aleo_prover-v0.2.6_ocl.tar.gz`.
4. On Nvidia: `tar -zvxf aleo_prover-v0.2.5_cuda_full_hotfix2.tar.gz && cd aleo_prover`, on AMD: `tar -zvxf aleo_prover-v0.2.6_ocl.tar.gz && cd aleo_prover`.
...
1. Choose your download url for your gpu.
  ...
  DOWNLOAD_URL for AMD: https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/ocl-v0.2.6/aleo_prover-v0.2.6_ocl.tar.gz
  ```
