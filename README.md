...
2. Download zkwork miner with `wget https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/v0.2.2/aleo_prover-v0.2.2-full.tar.gz`.
3. `tar -zvxf aleo_prover-v0.2.2-full.tar.gz && cd aleo_prover`.
...
Configuration:
- Installation URL: https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/v0.2.2/aleo_prover-v0.2.2-full.tar.gz
- Hash algorithm: aleo
